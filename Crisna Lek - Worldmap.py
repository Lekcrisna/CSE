world_map = {
    ...
    'SOUTH': {
        'NAME': 'RESTROOM',
        'DESCRIPTION': 'A restroom where you can do your business, you find a shiny item there.',
        'PATHS': {
            'NORTH', 'EAST'
        }
    },
    'EAST': {
        'NAME': 'BED ROOM',
        'DESCRIPTION': 'A place where you sleep and things you can go to sleep but you lose some time.'
    }
